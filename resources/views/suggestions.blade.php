            ...
            <div class="table-responsive">
              <div class="table-responsive">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @forelse($admin_suggestions as $key=>$suggestion)
                    <tr>
                      <td>{{ ++$key }}</td>
                      ...
                      <td>
                        <form action="{{ route('admin_delete_suggestion', $suggestion->slug) }}" method="POST">
                          @csrf
                          @method('DELETE')
                    ...
                    @empty
                    <tr><div class="alert alert-danger">No Suggestion</div></p></tr>
                    @endforelse
                  </tbody>
                </table>
              </div>
